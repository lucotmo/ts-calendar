...
import { LoginScreen } from '../../../../../ts-webpack-react-pwa/src/components/auth/LoginScreen';
import { startLogin, startRegister } from '../../../../../ts-webpack-react-pwa/src/actions/auth';
...
describe('Pruebas en <LoginScreen />', () => {
  ...
  test('Registro con contraseñas iguales', () => {
    ...
    expect(  startRegister ).toHaveBeenCalledWith('test@gmail.com', 'hola mundo', 'test');
  })
})
